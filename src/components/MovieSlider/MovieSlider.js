...
import { fetchUpcomingMovies } from "../../actions/index";
      ...
      <div className="home-swiper-container">
        <div className="opacity-wrapper">
          <div className="swiper-wrapper">
            ...
            <div
              style={{
                background: `linear-gradient(90deg,#000 0,transparent 50%,transparent) center center no-repeat, #fff url("${imgURL}${this.state.backDrop}") center top no-repeat`,
            ...
            >
              <div className="header-info">
                ...
                <p className="synopsis">{this.state.overview}</p>
                <div className="watch--trailer" onClick={this.handleShowModal}>
                  ...
                  <div className="watch--trailer__title">Watch Trailer</div>
                </div>
              </div>
            </div>
          </div>
