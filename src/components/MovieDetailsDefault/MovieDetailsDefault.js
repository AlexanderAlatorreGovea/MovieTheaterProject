...
class MovieDetailsDefault extends React.Component {
  ...
  componentDidMount() {
    axios
      .get(
        `${baseUrl}301528?api_key=${apiKey}&append_to_response=videos,details,images,movie_id`
      )
      .then((res) => {
        this.setState({
          ...
          <div className="container">
            <div className="container-wrapper">
              <div className="secondary__image--video">
                <div className="secondary__image">
                  <div className="secondary__image--wrapper">
                    <img
                      src={`http://image.tmdb.org/t/p/w780${secondaryImage}`}
                      alt="cover"
                      className="cover"
              ...
              <div
                className="hero"
                style={{
                  background: `url(http://image.tmdb.org/t/p/w1280/${this.state.img})`,
                }}
              >
