...
class MovieDetails extends React.Component {
    ...
    componentWillMount() {
        ...
        axios.get(`https://api.themoviedb.org/3/movie/${this.props.location.state.movie.id}/api_key=745fff882d6434c78ae4843ae559ef06&language=en-US&append_to_response=videos`).then(res => {
            this.setState({ 
