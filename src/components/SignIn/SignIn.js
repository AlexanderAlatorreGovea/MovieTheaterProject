                                ...
                                <div className="form-container sign-up-container">
                                    <form >
                                        ...
                                        <div className="social-container">
                                            <a className="social"><i className="facebook f icon"></i></a>
                                            <a className="social"><i className="google plus g icon"></i> </a>
                                            <a className="social"><i className="linkedin icon"></i></a>
                                        </div>
