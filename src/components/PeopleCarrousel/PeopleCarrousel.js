...
function NextArrow(props) {
  ...
  return (
    <div
      ...
      onClick={onClick}>
         <svg className='left--arrow__people' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M6.1 23.2L17.9 12 6.1.8"></path></svg>
      </div>
  );
}
...
function PrevArrow(props) {
  ...
  return (
    <div
      ...
      style={{ ...style, display: "block", background: "none" }}
      onClick={onClick}>
     <svg className='right--arrow__people' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" d="M17.9 23.2L6.1 12 17.9.8"></path></svg>
  </div>
  );
}
              ...
              <Slider {...settings}>
               ...
               {this.state.openModal && 
                  <PeopleModal 
                    ...
                    id={this.state.modalId ? this.state.modalId : "5a7aaa950e0a26020c003ea3"}
                    onClose={this.closeModal} 
                    personImage={this.state.personImage ? this.state.personImage : "/hYSoo0SAwr5vfh0jHU82JdBmP6V.jpg" }
                    img={this.state.profile_path}
                    name={this.state.name ? this.state.name : "Chris Geere"}
                    character={this.state.character ? this.state.character : "Roger Clifford"}   
