...
class MovieDetails extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showModal: false,
      additionalDetails: [],
      prevUrl: this.props.match.params,
    };
  }
  ...
  getItems = () => {
    ...
    axios
      .get(
        `${baseUrl}${this.props.location.state.movie.id}?api_key=${apiKey}&append_to_response=videos,details,images,movie_id,known_for_department,person_id,people`
      )
      .then((res) => {
        this.setState({
          details: res.data.genres,
          videos: res.data.videos.results,
          posters: res.data.images.posters[1],
  ...
  setRating = (rating) => {
    ...
    document
      .querySelectorAll(".star-rating-container__item")
      .forEach((node, i) => {
        if (i < rating) {
  ...
  forceUpdate = () => {
    ...
    const id = this.state.prevUrl;

    if (id !== webCurrentParams) {
          ...
          <div className="container">
            <div className="container-wrapper">
              <div className="secondary__image--video">
                <div className="secondary__image">
                  <div className="secondary__image--wrapper">
                    <img
                      src={`${MovieDetailsConfig.imgURL}w780${secondaryImage}`}
                      alt="cover"
                      className="cover"
              ...
              <div
                className="hero"
                style={{
                  background: `url( ${MovieDetailsConfig.imgURL}/w1280/${MovieDetailsConfig.movie.poster_path})`,
                }}
              >
                <div className="details">
                  <div className="title__and--ratings">
                    <div className="title1">
                      {`${MovieDetailsConfig.movie.original_title}`}
                      {ratings === false && (
                        <span className="rated__pg">PG-13</span>
                      )}
                  ...
                  <div className="rating">
                    ...
                    <span className="likes">
                      <i className="red small heart icon"></i>
                      {movieRatings} likes
                    </span>
                  </div>
                </div>{" "}
              ...
              <div className="description">
                <div className="column1">
                  <span className="tag">
                    {movieGenres[0] ? movieGenres[0].name : "action"}
                  </span>
                  <span className="tag">
                    {movieGenres[1] ? movieGenres[1].name : "XS"}
                  </span>
                  <span className="tag">
                    {movieGenres[2] ? movieGenres[2].name : "Thriller"}
                  </span>
                </div>{" "}
                {/* <!-- end column1 -->      */}
                <div className="column2">
                  <p>
                    {`${MovieDetailsConfig.movie.overview}`}
                ...
                <section className="production__info--section">
                    ...
                    <div className="production__info--wrapper">
                      ...
                      <div className="production__info--right">
                        ...
                        <div className="info__right--data">
                          ...
                          <span>
                            {movieGenres[0] && movieGenres[0].name},{" "}
                            {movieGenres[1] && movieGenres[1].name},{" "}
                            {movieGenres[3] && movieGenres[3].name}
                          </span>
                          <span>English</span>
                        </div>
                      </div>
                  ...
                  <div className="production__info--media">
                    <ul id="icons" style={{ display: "flex" }}>
                      <li>
                        <i id="icon" className="twitter icon"></i>
                      </li>
                      <li>
                        <i id="icon" className="facebook f icon"></i>
                      </li>
                      <li>
                        <i id="icon" className="instagram icon"></i>
                      </li>
                      <li>
                        <svg
                          className="tmdb"
                      ...
                      <li>
                        <i id="icon" className="linkify icon"></i>
                      </li>
                    </ul>
                  </div>
                </section>
                ...
                <Footer />
                <div
                  className="people-carrousel"
                  style={{ background: "black" }}
                >
                  {MovieDetailsConfig.movie.id && (
                    <PeopleCarrousel
                      time={this.format()}
