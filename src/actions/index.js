...
export const fetchUpcomingMovies = () =>  async dispatch => {
    ...
    const response = await movieCofig.get(`/upcoming?api_key=745fff882d6434c78ae4843ae559ef06&language=en-US&page=1&append_to_response=videos,details`);
...
export const fetchNowplayingMovies = () =>  async dispatch => {
    ...
    const response = await movieCofig.get(`/now_playing?api_key=745fff882d6434c78ae4843ae559ef06&language=en-US&page=1`);
...
export const fetchPopularMovies = () =>  async dispatch => {
    ...
    const response = await movieCofig.get(`/popular?api_key=745fff882d6434c78ae4843ae559ef06&language=en-US&page=1`);
...
export const fetchTopRatedMovies = () =>  async dispatch => {
    ...
    const response = await movieCofig.get(`/top_rated?api_key=745fff882d6434c78ae4843ae559ef06&language=en-US&page=1`);
