...
import { fetchPopularMovies } from '/Users/test/movietheaterprojectmaster/src/actions/index.js';
...
class PopularCarousel extends Component {
    componentWillMount(){
        console.log(this.props.fetchPopularMovies())
     }
                  ...
                  <Slider {...settings}>
                     {
                        ...
                        const movieImages =   this.props.popularMovies.filter((i) => {return i = 10 })
